...
<div class="demo-split">
    <Split v-model="split1">
        <div slot="left" class="demo-split-pane">
            <Card>
                <tables ref="tables" editable searchable stripe search-place="top" v-model="tableData" :columns="columns" :title="title" :pageTotal="pageTotal" :pageNum="pageNum" :addSearchBtn="addSearchBtn" :permaddBtn="permaddBtn" :permsReset="permsReset" :height="height" @on-delete="handleDelete" @onPageChage="onPageChage" @onPageSizeChage="onPageSizeChage" @onHandleSearch="onHandleSearch" @on-row-dblclick="onRowDblclick" @onResetBtn="onResetBtn" @on-perm-handle-from="onPermHandleFrom" />
            </Card>
        </div>
