...
<div>
    ...
    <div class="pageshow">
        <Page size="small" show-elevator show-sizer :total="pageTotal" :current="page.index" :page-size="page.size" @on-change="onChange" @on-page-size-change="onPageSizeChange" />
    </div>
