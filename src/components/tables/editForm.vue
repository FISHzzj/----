<template>
  <div class="formModel" v-if="formValidate.f_username">
    ...
    >
      ...
      <FormItem label="用户类型" prop="f_type">
        <Select v-model="formValidate.f_type" placeholder="请选择用户类型" style="width:186px">
          ...
          <Col span="11">
            <FormItem prop="f_birthday">
              <DatePicker
                type="date"
                placeholder="请选择出生日期"
                v-model="formValidate.f_birthday"
                style="width:186px"
              ></DatePicker>
            </FormItem>
          </Col>
      ...
      <FormItem label="头像" prop="f_img">
        <van-uploader :after-read="upFront" :before-read="upFrontBefore">
          <p
            :class="['upLoadIDCard', formValidate.f_img ? '' : 'plus']"
            :style="'background-image: url('+formValidate.f_img+')'"
          >
