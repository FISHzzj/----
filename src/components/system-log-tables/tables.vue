  ...
  <div>
    <div v-if="searchable && searchPlace === 'top'" class="search-con search-con-top">
      <div class="getTime" v-show="userName">
        <span>用户姓名：</span>
        <Input  placeholder="输入用户姓名" class="search-input" v-model="searchUserName"/>
      </div>
      <div class="getTime" v-show="userMobile">
        <span>用户手机：</span>
        <Input  placeholder="输入用户手机" class="search-input" v-model="searchUserMobile"/>
      </div>
      <div class="getTime" v-show="getUrl">
        <span>请求URL：</span>
        <Input placeholder="输入关键字搜索" class="search-input" v-model="searchGetUrl"/>
      </div>
      <div class="getTime">
        <span>请求时间：</span>
      ...
      <div class="getTime" v-if="searchCol">
        ...
        <Select v-model="searchKey" class="search-col" >
          <Option v-for="item in evevtType" :value="item.key" :key="`search-col-${item.key}`">{{ item.title }}</Option>
        </Select>
      </div>
      <Input @on-change="handleClear" clearable placeholder="输入关键字搜索" class="search-input" v-model="searchValue" v-if="searchValueIf"/>
        ...
        return h(TablesEdit, {
          ...
          on: {
            ...
            'on-save-edit': (params) => {
              ...
              this.$emit('on-save-edit', Object.assign(params, { [params.column.key]: this.edittingText, id: params.row.id }))
              this.edittingCellId = ''
            }
          }
        })
